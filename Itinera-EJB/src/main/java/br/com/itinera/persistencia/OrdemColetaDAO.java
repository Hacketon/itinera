...
public class OrdemColetaDAO {
    ...
    public List<OrdemColeta> buscarPorPeriodoENotaFiscal(Date inicio, Date fim, BigDecimal nota) {
    ...
    public List<OrdemColeta> buscarPorNotaFiscal(BigDecimal nota) {
        return em.createNamedQuery("OrdemColeta.findByNumeroNota")
                .setParameter("numeroNota", nota)
                .getResultList();
    }

    public List<OrdemColeta> buscarPorPeriodoInicioNotaFiscal(Date inicio, BigDecimal nota) {
    ...
    public List<OrdemColeta> buscarPorPeriodoFimNotaFiscal(Date fim, BigDecimal nota) {
