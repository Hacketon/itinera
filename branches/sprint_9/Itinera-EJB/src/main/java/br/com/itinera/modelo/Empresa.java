...
@NamedQueries({
    ...
    @NamedQuery(name = "Empresa.findByCnpj", query = "SELECT e FROM Empresa e WHERE lower(e.cnpj) like lower(:cnpj)"),
    @NamedQuery(name = "Empresa.findByIe", query = "SELECT e FROM Empresa e WHERE lower(e.ie) like lower(:ie)"),
